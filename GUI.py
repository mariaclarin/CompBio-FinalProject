...
if platform.system()=='Darwin':
    ...
    def landingPage(root):
        ...
        title.place(relx=0.135, rely=0.24)
        title1 = Label(
            root,
            font=(myFont, 30),
            text="Simulator",
        ...
        title1.place(relx=0.135, rely=0.31)
        ...
        title2.place(relx=0.135, rely=0.395)
        title2 = Label(
            root,
            font=(myFont, 20),
            text="___________",
        ...
        disclaimer2 = Label(
            root,
            font=(myFont, 8),
            text="biological assessments of paternity or biological affinity. Data",
            foreground="white",
            bg="#494E73",
        )
        disclaimer2.place(relx=0.135, rely=0.554)
        disclaimer3 = Label(
            root,
            font=(myFont, 8),
            text="used for testing publically available DNA sequences or",
            foreground="white",
            bg="#494E73",
        )
        disclaimer3.place(relx=0.135, rely=0.576)
        disclaimer4 = Label(
            root,
            font=(myFont, 8),
            text="synthetically mutated DNA sequences.",
            foreground="white",
            bg="#494E73",
        )
        disclaimer4.place(relx=0.135, rely=0.598)
    ...
    def results(root, fatherdna, childdna):
        ...
        title.place(relx=0.12, rely=0.05)
        instruction = Label(
            root,
            font=(myFont, 12),
            text="Here are the genetic markers found in the alleged father and child DNA to indicate paternity probability",
        ...
        instruction.place(relx=0.12, rely=0.14)
        ...
        if resultcolor==1:
            ...
            resultstitles.place(relx=0.12, rely=0.18)
        else:
            resultstitles = Label(
                root,
                font=(myFont, 20),
        ...
        resultstitles1.place(relx=0.7, rely=0.18)
        resultstitles2 = Label(
            root,
            font=(myFont, 10),
            text=childmarkerlen,
        ...
        resultstitles2.place(relx=0.835, rely=0.18)
        resultstitles3 = Label(
            root,
            font=(myFont, 10),
            text='No. of Father Markers: ',
        ...
        resultstitles3.place(relx=0.7, rely=0.205)
        resultstitles4 = Label(
            root,
            font=(myFont, 10),
            text=fathermarkerlen,
        ...
        resultstitles4.place(relx=0.835, rely=0.205)

        resultTable.place(relx=0.12, rely=0.245)
        results_label = tk.Label(root, text= resultdescription, font=('Helvetica', 12), bg="#182052", foreground="white")
        results_label.place(relx=0.12, rely=0.715)

        disclaimer_label = tk.Label(root, text="This program is for educational purposes to simulate a simple paternity probability algorithm. It should not be used for true biological", font=('Helvetica', 9), bg="#182052", foreground="#737BB6")
        disclaimer_label.place(relx=0.12, rely=0.75)   
        disclaimer1_label = tk.Label(root, text="assessments of paternity or biological affinity. Data used for testing publically available DNA sequences available DNA sequences or ", font=('Helvetica', 9), bg="#182052", foreground="#737BB6")
        disclaimer1_label.place(relx=0.12, rely=0.78)   
        disclaimer2_label = tk.Label(root, text=" synthetically mutated DNA sequences. ", font=('Helvetica', 9), bg="#182052", foreground="#737BB6")
        disclaimer2_label.place(relx=0.12, rely=0.81)   
        ...
        exportButton = tk.Button(root, text="Export Results", command=lambda: export_button_click(resultTable), font=(myFont, 12))
        exportButton.place(relx=0.27, rely=0.86)
        returnButton = Button(
            root,
            font=(myFont, 12),
            command=lambda: landingPage(root),
        ...
        returnButton.place(relx=0.12, rely=0.86)
    ...
    def dnaInput(root):
        ...
        title.place(relx=0.137, rely=0.05)
        instruction = Label(
            root,
            font=(myFont, 15),
            text="Type the alleged father's DNA sequence or load a file (.txt)",
        ...
        instruction.place(relx=0.137, rely=0.13)

        global fatherinput
        fatherinput = tk.Text(root, wrap='word', width=100, height=10)
        fatherinput.place(relx=0.137,rely=0.18 )
        ...
        loadfatherbutton.place(relx=0.137, rely=0.43)
        ...
        instruction1.place(relx=0.137, rely=0.48)

        global childinput
        childinput = tk.Text(root, wrap='word', width=100, height=10)
        childinput.place(relx=0.137,rely=0.53 )
        ...
        loadchildbutton.place(relx=0.137, rely=0.78)
        ...
        testButton.place(relx=0.24, rely=0.84)
        ...
        returnButton.place(relx=0.137, rely=0.84)
